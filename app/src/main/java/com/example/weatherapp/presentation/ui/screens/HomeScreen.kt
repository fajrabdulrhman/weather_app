...
@Composable
fun ScreenContent(weatherResponseDto: WeatherResponseDto?,navController: NavController) {
...
@Composable
fun TodayForecast(hours: List<Hour>, formattedDate: String) {
    Column(
        modifier = Modifier
            .height(160.dp)
            .width(380.dp)
...
@Composable
fun ForecastHourItem(hour: Hour) {
    val inputFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm", Locale.ENGLISH)
...
@Composable
fun ForCastDays(forecastday: List<Forecastday>) {
...
@Composable
fun ForeCastDaysItem(forecastday: Forecastday) {
